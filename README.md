...
1.4.0 将社交平台动态升级为近期研究资料监测：默认回溯 30 天并按最新发布日期排序，自动覆盖平台政策、算法、广告、Reels、爆款内容和账号增长等主题。Windows 版新增任务栏通知区域图标，可随时打开管理页面或彻底退出后台程序。1.3.0 已加入新闻单条/全部复制、版本显示和 GitHub 更新检查。
